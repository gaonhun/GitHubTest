...
<link rel="stylesheet" type="text/css" href="./resources/css/oms_sub04_02.css" />
...
<body>
	...
	<header>
		...
		<div id="header_title"><p>매장관리&nbsp; &nbsp;>&nbsp; &nbsp; 배송채널사 정산</p></div>
	...
	<section class='div_header'>
		<div class='search_div' onkeyup='onEnterSearch();'>
			<p id='dcnm_p'>배송채널명</p>
			<div class="search_form" id="dcnm_form">
				<input class='search_box' type="search" id='dcnm' name='dcnm' readonly /><img src="./resources/img/icon_search_hover.png"
					id='dcnm_img' />
			</div>
			<input type='text' id='dccd' name='dccd' hidden />
